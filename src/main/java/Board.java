...
public class Board {
    ...
    private WinnerGame picker = new WinnerGame();
    ...
    public FlowPane getBoard() {
        ...
        flow.setStyle("-fx-background-color: #ffb700");

        for (int i = 0; i < 9; i++) {
            boxes[i] = new ImageView(new Image(Board.class.getResourceAsStream("back.png")));
